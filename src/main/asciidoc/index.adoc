...
include::{snippets}/v1/beerUpc-get/curl-request.adoc[]

One showing the HTTP request:

include::{snippets}/v1/beerUpc-get/http-request.adoc[]

And one showing the HTTP response:

include::{snippets}/v1/beerUpc-get/http-response.adoc[]

Response Body:
include::{snippets}/v1/beerUpc-get/response-body.adoc[]

Response Fields:
include::{snippets}/v1/beerUpc-get/response-fields.adoc[]
